...
try {
    ...
    $num_people = stripcslashes($_POST['num_people']);
    $age = stripcslashes($_POST['age']);
    $phone = stripcslashes($_POST['phone']);
    $whatsapp = stripcslashes($_POST['whatsapp']);

    $subject = 'Health Insurance Contact Form'; // Define your email subject
    ...
    $message .= "Number of People for Insurance: $num_people<br /><br />";
    $message .= "Age of People for Insurance: $age<br /><br />";
