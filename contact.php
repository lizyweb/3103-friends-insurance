...
try {
    ...
    $insurance = stripcslashes($_POST['insurance']);
    $comments = stripcslashes($_POST['comments']);

    $subject = 'Friends Motors & Insurance Contact Form'; // Define your email subject
    ...
    $mail->addAddress('friendsinsurance@gmail.com');
    ...
    $message .= "Insurance Type: $insurance<br /><br />";
